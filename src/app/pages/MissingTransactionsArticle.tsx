...
export default function MissingTransactionsArticle() {
  return (
    <div className="max-w-3xl mx-auto px-4 md:px-8 py-8">
      <Breadcrumb items={[{ label: "Troubleshooting", path: "/troubleshooting" }, { label: "Missing Transactions" }]} />

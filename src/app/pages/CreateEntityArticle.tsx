...
export default function CreateEntityArticle() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 md:px-8 py-8">
      <Breadcrumb items={[{ label: "Get Started", path: "/get-started" }, { label: "Creating an Entity" }]} />
      ...
      <h1 className="text-white text-3xl font-bold mb-6 leading-tight">Creating an Entity</h1>
      ...
      <div className="mt-10 mb-8">
        <h2 className="text-white text-xl font-semibold mb-6">Steps to Create Your Entity</h2>

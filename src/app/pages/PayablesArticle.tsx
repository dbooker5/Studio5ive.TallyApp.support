...
export default function PayablesArticle() {
  return (
    <div className="max-w-3xl mx-auto px-4 md:px-8 py-8">
      <Breadcrumb items={[{ label: "Suppliers", path: "/suppliers" }, { label: "Payables" }]} />

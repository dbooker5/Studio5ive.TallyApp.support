...
export default function ProfitLossReportArticle() {
  return (
    <div className="max-w-3xl mx-auto px-4 md:px-8 py-8">
      <Breadcrumb items={[{ label: "Reports", path: "/reports" }, { label: "Reports & Analytics" }]} />
      ...
      <h1 className="text-white text-3xl font-bold mb-6 leading-tight">Reports & Analytics</h1>
      <p className="text-[#A1A1AA] text-[15px] leading-relaxed mb-6">Explore detailed financial insights, track key metrics, and generate comprehensive business reports.</p>
      <VideoGuide title="Reports & Analytics" subtitle="A quick walk-through tutorial" duration="2:00" />
      <div className="mt-10 mb-8"><h2 className="text-white text-xl font-semibold mb-6">Step-by-Step Guide</h2>
        <div className="space-y-6 mb-10">
          ...
          <div className="flex gap-4"><div className="flex-shrink-0 w-7 h-7 rounded-full bg-[#22D3EE]/15 border border-[#22D3EE]/30 flex items-center justify-center text-[#22D3EE] text-xs font-bold mt-0.5">3</div><div><p className="text-white font-semibold text-[15px] mb-1">Analyze</p><p className="text-[#A1A1AA] text-sm leading-relaxed">Review your gross profit, expenses, and net profit, etc.</p></div></div>
        </div>
      </div>
      <HelpFooter />
    </div>

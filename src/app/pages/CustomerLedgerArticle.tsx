...
export default function CustomerLedgerArticle() {
  return (
    <div className="max-w-3xl mx-auto px-4 md:px-8 py-8">
      <Breadcrumb items={[{ label: "Customers", path: "/customers" }, { label: "Customer Ledger" }]} />
      ...
      <h1 className="text-white text-3xl font-bold mb-6 leading-tight">Customer Ledger</h1>
      <p className="text-[#A1A1AA] text-[15px] leading-relaxed mb-6">View the full transaction history for any customer.</p>
      <VideoGuide title="Viewing Customer Ledgers" subtitle="A quick walk-through tutorial" duration="2:00" />
      <div className="mt-10 mb-8"><h2 className="text-white text-xl font-semibold mb-6">Step-by-Step Guide</h2>
        <div className="space-y-6 mb-10">
          <div className="flex gap-4"><div className="flex-shrink-0 w-7 h-7 rounded-full bg-[#0EA5E9]/15 border border-[#0EA5E9]/30 flex items-center justify-center text-[#0EA5E9] text-xs font-bold mt-0.5">1</div><div><p className="text-white font-semibold text-[15px] mb-1">Select Customer</p><p className="text-[#A1A1AA] text-sm leading-relaxed">Tap on a customer's name from your list.</p></div></div>
